from utilsADCN import evenly,listCollectS,amazonDataLoaderUniform
from utilsADCN_bert import sourceAndTargetAmazonLoader
from model import ConvAeAM, simpleMPL
...
def run_leopard(params):
    ...
    for s, t in zip(Source,Target):
        ...
        paramstamp = ('Leopard++_bert_mlp_' + TypeRun+str(nRoundTest)+'Times_'+str(portion)+'Portion_'
